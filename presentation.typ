...
// Color palette for semantic consistency
#let stream-color = rgb("e6f3ff")      // Light blue for streams/sources
#let operator-color = rgb("fff0e6")    // Light orange for operators/transforms
#let data-color = rgb("fff3cd")        // Light yellow for data/items
#let pin-color = rgb("#2b67df")         // Light red for Pin concepts
#let state-color = rgb("f0ffe6")       // Light green for states/processes
#let ui-color = rgb("f0e6ff")          // Light purple for UI/interface
#let text-green = rgb("#00a400")  // Dark green for text elements
  ...
  *What I observed:*
  ...
  #align(center)[
    #canvas(length: 1cm, {
      ...
      line((0.8, 1.8), (3.2, 1.8), mark: (end: ">"), stroke: blue + arrow-width)
  ...
  #align(center)[
    #canvas(length: 1cm, {
      ...
      let draw-timeline-entry(y, year, event, description, reference, ref-url, color) = {
        ...
        line((0.8, y), (1, y), stroke: gray + stroke-width)
      }
  ...
  #align(center)[
    #fletcher.diagram(
      ...
      spacing: (1em, 2em),
      {
        ...
        edge((0, 0), (0, 1), "-|>", stroke: orange + arrow-width, label: "OS abstraction")
        edge((0, 1), (0, 2), "-|>", stroke: blue + arrow-width, label: "Stream operators")
        ...
        edge((-1, 1), (0, 1), "->", stroke: gray + arrow-width)

        node((-1, 2), [In this presentation], stroke: none)
        edge((-1, 2), (0, 2), "->", stroke: gray + arrow-width)
      },
    )
  ]
...
#slide[
  ...
  #align(center + horizon)[
    ...
    #diagram(
      ...
      // Iterator calls
      node((0, 4), [next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((0, 3), [next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((0, 2), [next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((0, 1), [next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),

      // Iterator results
      node((1, 4), [Some(1)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((1, 1), [Some(2)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((1, 2), [Some(3)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((1, 3), [None], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      ...
      // Stream calls
      node((3, 4), [poll_next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((3, 3), [poll_next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((3, 2), [poll_next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((3, 1), [poll_next()], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),

      // Stream results
      node((4, 4), [Pending], fill: state-color, stroke: state-color.darken(stroke-darken) + stroke-width),
      node((4, 3), [Ready(Some(1))], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((4, 2), [Pending], fill: state-color, stroke: state-color.darken(stroke-darken) + stroke-width),
      node((4, 1), [Ready(Some(2))], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      ...
      // Stream async calls
      node((6, 4), [next().await], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width),
      node((6, 3), [next().await], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width),
      node((6, 2), [next().await], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width),
      node((6, 1), [next().await], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width),

      // Stream async results
      node((7, 4), [Some(1)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((7, 1), [Some(2)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((7, 2), [Some(3)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      node((7, 3), [None], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
  ...
  #align(center)[
    ...
    #diagram(
      ...
      node(
        ...
        [`iter(0..10)`],
        fill: stream-color,
        stroke: stream-color.darken(stroke-darken) + stroke-width,
        shape: circle,
      ),
      node(
        (1, 2),
        [`map(*2)`],
        fill: operator-color,
        stroke: operator-color.darken(stroke-darken) + stroke-width,
        shape: rect,
      ),
      node(
        (2, 2),
      ...
      node(
        ...
        [0,2,4,6...],
        fill: data-color,
        stroke: data-color.darken(stroke-darken) + stroke-width,
        shape: rect,
      ),
      node((2, 1), [6,8,10...], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width, shape: rect),
      node(
        (3, 1),
        [(0,6),(1,8)...],
        fill: data-color,
      ...
      node((5, 1), [(1,8),(2,10)], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),
      ...
      node((5, 0), [skip while < 1], fill: operator-color, stroke: operator-color.darken(stroke-darken) + stroke-width),
  ...
  #text(size: 8pt)[
    #align(center + horizon)[
      ...
      #canvas(length: 1.2cm, {
        ...
        circle((1, 2), radius: 0.8, fill: operator-color, stroke: operator-color.darken(stroke-darken) + stroke-width)
        content((1, 3), text(size: 7pt, weight: "bold", [`&mut Double`], fill: orange), anchor: "center")
        circle((1, 2), radius: 0.4, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
        content((1, 2), text(size: 6pt, fill: text-green, [`InSt`]), anchor: "center")

        // First arrow with .get_mut() label
        line((2.7, 2), (3.5, 2), mark: (end: ">"), stroke: green + arrow-width)
        content((3, 2.4), text(size: 7pt, fill: blue, [?]), anchor: "center")

        // Middle: Just InSt
        circle((4, 2), radius: 0.4, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
        content((4, 2), text(size: 6pt, fill: text-green, [`InSt`]), anchor: "center")

        // Second arrow with Pin::new() label
        line((4.5, 2), (5.3, 2), mark: (end: ">"), stroke: green + arrow-width)
        ...
        circle((6.5, 2), radius: 0.4, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
        content((6.5, 2), text(size: 6pt, fill: text-green)[`InSt`], anchor: "center")

        // Third arrow with next().await label
        line((7.5, 2), (8.5, 2), mark: (end: ">"), stroke: purple + arrow-width)
      ...
      #grid(
        ...
        [
          #canvas(length: 1cm, {
            ...
            line((1.8, 2.7), (7.2, 2.7), mark: (end: ">"), stroke: blue + arrow-width)
            ...
            line((7.2, 1.7), (1.8, 1.7), mark: (end: ">"), stroke: green + arrow-width)
        ...
        [
          #canvas(length: 1cm, {
            ...
            line((2.5, 2.8), (6.5, 1.8), stroke: red + arrow-width)
            line((2.5, 1.8), (6.5, 2.8), stroke: red + arrow-width)
  ...
  #text(size: 8pt)[
    #align(center)[
      #canvas(length: 1.2cm, {
        ...
        rect((1.3, 3.5), (3.7, 4.5), fill: gray, stroke: gray.darken(stroke-darken) + stroke-width, radius: node-radius)
        ...
        // Arrow to heap
        line((3.5, 4), (7.3, 3.7), mark: (end: ">"), stroke: orange + arrow-width)
        ...
        arc((10.5, 5.2), start: 60deg, stop: 170deg, radius: 1.5, mark: (end: ">"), stroke: red + arrow-width)

        // Heap - actual stream (triangle laying flat)
        line((6.0, 3), (10, 3), stroke: orange + stroke-width) // base
        line((6.0, 3), (8, 5), stroke: orange + stroke-width) // left side
        line((10, 3), (8, 5), stroke: orange + stroke-width) // right side
...
#slide[
  ...
  #align(center)[
    #canvas(length: 1.2cm, {
      ...
      circle((2, 4), radius: 1.5, fill: operator-color, stroke: operator-color.darken(stroke-darken) + stroke-width)
      content((2, 5.7), text(size: 7pt, weight: "bold", fill: orange)[`&mut Double`], anchor: "center")
      ...
      circle((2, 4), radius: 0.5, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
      content((2, 4), text(size: 6pt, fill: text-green)[`InSt:` \ `!Unpin`], anchor: "center")


      content((2, 5.2), text(size: 6pt, weight: "bold", text(fill: black)[`Box<InSt>`]), anchor: "center")

      // First arrow: Pin::get_mut()
      line((4.4, 4), (5.4, 4), mark: (end: ">"), stroke: green + arrow-width)
      content(
        (4.9, 4.5),
        text(size: 6pt, weight: "bold", fill: text-green)[`Pin::get_mut()`],
        anchor: "center",
      )
      ...
      // Smooth curved arrow going into triangle center
      arc((4.0, 5.8), start: 80deg, stop: 170deg, radius: 1.5, mark: (end: ">"), stroke: red + arrow-width)
      // Box outline

      // Middle: &mut Box<InSt>
      content((6.5, 5.2), text(size: 7pt, weight: "bold", fill: orange)[`&mut Double`], anchor: "center")
      circle((6.5, 4), radius: 1, fill: operator-color, stroke: operator-color.darken(stroke-darken) + stroke-width)
      content((6.5, 4.7), text(size: 7pt, weight: "bold", fill: black)[`Box<InSt>`], anchor: "center")
      rect(
        (6.5 - 0.45, 4 - 0.45),
        (6.5 + 0.45, 4 + 0.45),
        fill: gray,
        stroke: gray.darken(stroke-darken) + stroke-width,
      )
      circle((6.5, 4), radius: 0.3, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
      content((6.5, 4), text(size: 5pt, fill: text-green)[`InSt`], anchor: "center")


      // Second arrow: Pin::new()
      line((7.1, 4), (8.9, 4), mark: (end: ">"), stroke: green + arrow-width)
      content(
        (7.9, 4.5),
        text(size: 6pt, weight: "bold", fill: text-green)[`Pin::new()`],
        anchor: "center",
      )
      ...
      content((9.5, 4.7), text(size: 7pt, weight: "bold", fill: black)[`&mut Box<InSt>`], anchor: "center")
      ...
      circle((9.5, 4.1), radius: 0.3, fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
      content((9.5, 4.1), text(size: 5pt, fill: text-green)[`InSt`], anchor: "center")


      // Third arrow: Stream::poll_next()
      line((11.0, 4), (11.7, 4), mark: (end: ">"), stroke: purple + arrow-width)
      content(
        (11.5, 4.5),
        text(size: 6pt, weight: "bold", fill: purple)[`poll_next()`],
        anchor: "center",
      )
    })
  ]
...
#slide[
  ...
  #align(center + horizon)[
    #diagram(
      ...
      // Main stream nodes
      node((0, 1), [`InputStream`], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width),
      node((1, 1), [`Fork`], fill: operator-color, stroke: operator-color.darken(stroke-darken) + stroke-width),
      node((2, 2), [Bob], fill: state-color, stroke: state-color.darken(stroke-darken) + stroke-width),
      node((2, 0), [Alice], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width),
      ...
      node((4, 1), ['c'], fill: gray.lighten(40%), stroke: gray + stroke-width, shape: fletcher.shapes.rect),
      node((4.5, 1), ['d'], fill: gray.lighten(40%), stroke: gray + stroke-width, shape: fletcher.shapes.rect),
      ...
      // Main flow edges
      edge((0, 1), (1, 1), [`.fork()`], "->", stroke: blue + arrow-width, label-pos: 0.4),
      edge((1, 1), (2, 2), [`.clone()`], "->", stroke: purple + arrow-width, bend: -20deg),
      edge((1, 1), (2, 0), [`.clone()`], "->", stroke: purple + arrow-width, bend: 20deg),

      // Data flow edges

      edge((2, 0), (3, -1), "->", stroke: orange + stroke-width),
      edge((1, 1), (3, 1), text(fill: gray)[queue], "--", stroke: gray + stroke-width),
      edge((2, 2), (3, 3), "->", stroke: orange + stroke-width),
    )
  ]
]
  ...
  #align(center)[
    #diagram(
      ...
      node(
        ...
        [Alice\ 💤 Sleeping],
        fill: ui-color,
        stroke: ui-color.darken(stroke-darken) + stroke-width,
        shape: fletcher.shapes.circle,
      ),
      ...
      node((1, 1.5), [data 'x'], fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width),

      // Flow sequence with better spacing

      edge((0, 3), (1, 0), [1. `poll_next()`], "->", stroke: gray + stroke-width, bend: 50deg, label-pos: 79%),
      edge((1, 0), (0, 3), [2. `Pending`], "->", stroke: gray + stroke-width, bend: -85deg, label-pos: 90%),


      edge((2, 3), (1, 0), [3. `poll_next()`], "->", stroke: green + arrow-width, bend: -50deg, label-pos: 70%),


      edge((1, 0), (1, 1.5), [4. `Ready`], "->", stroke: orange + arrow-width),


      edge((2, 3), (0, 3), [5. `wake()` Alice], "->", stroke: green + arrow-width, bend: 40deg),

      edge((0, 3), (1, 1.5), [6. `poll_next()`], "->", stroke: green + stroke-width, bend: -40deg, label-pos: 30%),
      edge((1, 1.5), (0, 3), [7. `clone()`], "->", stroke: orange + stroke-width, bend: -40deg, label-pos: 30%),
      edge((1, 1.5), (2, 3), [8. original], "->", stroke: orange + stroke-width, bend: 40deg, label-pos: 30%),
    )
  ]
  ...
  #align(center + horizon)[
    ...
    #diagram(
      ...
      node(
        ...
        fill: state-color,
        stroke: state-color.darken(stroke-darken) + stroke-width,
      ),
      ...
      // Iteration loop
      edge((1, 1), (2, 2), text(size: 6pt)[✗ fail], "->", bend: -30deg, stroke: red + stroke-width),
    )
  ]
...
#slide[
  ...
  #align(center)[
    #diagram(
      ...
      {
        // Stream source
        node((0, 1), [`Stream`], fill: stream-color, stroke: stream-color.darken(stroke-darken) + stroke-width)
        ...
        // Sink destination
        node((3, 1), [`Sink`], fill: ui-color, stroke: ui-color.darken(stroke-darken) + stroke-width)
...
#slide[
  ...
  #align(center + horizon)[
    #canvas(length: 1cm, {
      ...
      // Data flow upward
      line((4, 2.2), (4, 2.8), stroke: orange + arrow-width, mark: (end: ">"))
...
#slide[
  ...
  #rect(inset: 5mm, fill: data-color, stroke: data-color.darken(stroke-darken) + stroke-width, radius: node-radius)[
...
#slide[
  ...
  #align(center)[
    #canvas(length: 1cm, {
      ...
      // GC cleanup
      circle((2, 2.8), radius: 0.4, fill: state-color, stroke: state-color.darken(stroke-darken) + stroke-width)
      ...
      line((6.2, 2.2), (6.8, 2.2), stroke: blue + arrow-width)
      line((6.8, 2.2), (7.2, 1.8), stroke: blue + arrow-width, mark: (end: ">"))
      line((7.2, 1.8), (7.8, 1.8), stroke: blue + arrow-width)
